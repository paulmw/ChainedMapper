...
public class SecondMapper extends MapReduceBase implements Mapper<LongWritable, Text, LongWritable, Text> {
	...
	public void map(LongWritable key, Text value, OutputCollector<LongWritable, Text> output, Reporter arg3) throws IOException {
		...
		String nice = line.replaceAll("\\.", "; for he wasn't caught that day.");
		value.set(nice);
